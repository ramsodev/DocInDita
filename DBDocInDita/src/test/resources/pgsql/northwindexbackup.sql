...
ALTER TABLE northwind.customercustomerdemo OWNER TO postgres;
...
ALTER TABLE northwind.customerdemographics OWNER TO postgres;
...
ALTER TABLE northwind.employeeterritories OWNER TO postgres;
...
ALTER TABLE northwind.usstates OWNER TO postgres;

--
-- Data for Name: categories; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY northwind.categories (categoryid, categoryname, description, picture) FROM stdin;
...
COPY northwind.customercustomerdemo (customerid, customertypeid) FROM stdin;
\.
...
COPY northwind.customerdemographics (customertypeid, customerdesc) FROM stdin;
\.
...
COPY northwind.employees (employeeid, lastname, firstname, title, titleofcourtesy, birthdate, hiredate, address, city, region, postalcode, country, homephone, extension, photo, notes, reportsto, photopath) FROM stdin;
...
COPY northwind.employeeterritories (employeeid, territoryid) FROM stdin;
1	06897
1	19713
2	01581
2	01730
...
COPY northwind.orders (orderid, customerid, employeeid, orderdate, requireddate, shippeddate, shipvia, freight, shipname, shipaddress, shipcity, shipregion, shippostalcode, shipcountry) FROM stdin;
...
COPY northwind.region (regionid, regiondescription) FROM stdin;
1	Eastern
2	Western
3	Northern
4	Southern
...
COPY northwind.territories (territoryid, territorydescription, regionid) FROM stdin;
01581	Westboro	1
01730	Bedford	1
01833	Georgetow	1
02116	Boston	1
...
COPY northwind.usstates (stateid, statename, stateabbr, stateregion) FROM stdin;
1	Alabama	AL	south
2	Alaska	AK	north
3	Arizona	AZ	west
4	Arkansas	AR	south
...
REVOKE ALL ON TABLE northwind.categories FROM PUBLIC;
REVOKE ALL ON TABLE northwind.categories FROM postgres;
GRANT ALL ON TABLE northwind.categories TO postgres;
...
REVOKE ALL ON TABLE northwind.customercustomerdemo FROM PUBLIC;
REVOKE ALL ON TABLE northwind.customercustomerdemo FROM postgres;
GRANT ALL ON TABLE northwind.customercustomerdemo TO postgres;
...
REVOKE ALL ON TABLE northwind.customerdemographics FROM PUBLIC;
REVOKE ALL ON TABLE northwind.customerdemographics FROM postgres;
GRANT ALL ON TABLE northwind.customerdemographics TO postgres;
...
REVOKE ALL ON TABLE northwind.customers FROM PUBLIC;
REVOKE ALL ON TABLE northwind.customers FROM postgres;
GRANT ALL ON TABLE northwind.customers TO postgres;
...
REVOKE ALL ON TABLE northwind.employees FROM PUBLIC;
REVOKE ALL ON TABLE northwind.employees FROM postgres;
GRANT ALL ON TABLE northwind.employees TO postgres;
...
REVOKE ALL ON TABLE northwind.employeeterritories FROM PUBLIC;
REVOKE ALL ON TABLE northwind.employeeterritories FROM postgres;
GRANT ALL ON TABLE northwind.employeeterritories TO postgres;
...
REVOKE ALL ON TABLE northwind.order_details FROM PUBLIC;
REVOKE ALL ON TABLE northwind.order_details FROM postgres;
GRANT ALL ON TABLE northwind.order_details TO postgres;
...
REVOKE ALL ON TABLE northwind.orders FROM PUBLIC;
REVOKE ALL ON TABLE northwind.orders FROM postgres;
GRANT ALL ON TABLE northwind.orders TO postgres;
...
REVOKE ALL ON TABLE northwind.products FROM PUBLIC;
REVOKE ALL ON TABLE northwind.products FROM postgres;
GRANT ALL ON TABLE northwind.products TO postgres;
...
REVOKE ALL ON TABLE northwind.region FROM PUBLIC;
REVOKE ALL ON TABLE northwind.region FROM postgres;
GRANT ALL ON TABLE northwind.region TO postgres;
...
REVOKE ALL ON TABLE northwind.shippers FROM PUBLIC;
REVOKE ALL ON TABLE northwind.shippers FROM postgres;
GRANT ALL ON TABLE northwind.shippers TO postgres;
...
REVOKE ALL ON TABLE northwind.suppliers FROM PUBLIC;
REVOKE ALL ON TABLE northwind.suppliers FROM postgres;
GRANT ALL ON TABLE northwind.suppliers TO postgres;
...
REVOKE ALL ON TABLE northwind.territories FROM PUBLIC;
REVOKE ALL ON TABLE northwind.territories FROM postgres;
GRANT ALL ON TABLE northwind.territories TO postgres;
...
REVOKE ALL ON TABLE northwind.usstates FROM PUBLIC;
REVOKE ALL ON TABLE northwind.usstates FROM postgres;
GRANT ALL ON TABLE northwind.usstates TO postgres;
