...
ALTER TABLE empex.bonus OWNER TO postgres;
...
ALTER TABLE empex.department OWNER TO postgres;
...
ALTER TABLE empex.employees OWNER TO postgres;
...
ALTER TABLE empex.salary_grade OWNER TO postgres;

--
-- Data for Name: bonus; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY empex.bonus (emp_name, job_name, salary, commission) FROM stdin;
\.
...
COPY empex.department (dep_id, dep_name, dep_location) FROM stdin;
1001	FINANCE	SYDNEY
...
COPY empex.employees (emp_id, emp_name, job_name, manager_id, hire_date, salary, commission, dep_id) FROM stdin;
...
COPY empex.salary_grade (grade, min_sal, max_sal) FROM stdin;
1	800	1300
2	1301	1500
3	1501	2100
4	2101	3100
...
ALTER TABLE ONLY empex.department
...
ALTER TABLE ONLY empex.employees
...
REVOKE ALL ON TABLE empex.bonus FROM PUBLIC;
REVOKE ALL ON TABLE empex.bonus FROM postgres;
GRANT ALL ON TABLE empex.bonus TO postgres;
...
REVOKE ALL ON TABLE empex.department FROM PUBLIC;
REVOKE ALL ON TABLE empex.department FROM postgres;
GRANT ALL ON TABLE empex.department TO postgres;
...
REVOKE ALL ON TABLE empex.employees FROM PUBLIC;
REVOKE ALL ON TABLE empex.employees FROM postgres;
GRANT ALL ON TABLE empex.employees TO postgres;
...
REVOKE ALL ON TABLE empex.salary_grade FROM PUBLIC;
REVOKE ALL ON TABLE empex.salary_grade FROM postgres;
GRANT ALL ON TABLE empex.salary_grade TO postgres;
